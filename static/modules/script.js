...
function AddaScene() {
    ...
    <a-scene embedded artoolkit='patternRatio: 500; sourceType: webcam;' id="thescene">
        ...
        <a-assets> <!-- assets must be a child of scene -->
            <a-asset-item id="carboxy_obj" src="../static/assets/objAfinal.obj"></a-asset-item>
            <a-asset-item id="carboxy_mtl" src="../static/assets/objAfinal.mtl"></a-asset-item>
        </a-assets>
        
        <a-assets> 
            <a-asset-item id="alcohol_obj" src="../static/assets/objBfinal.obj"></a-asset-item>
            <a-asset-item id="alcohol_mtl" src="../static/assets/objBfinal.mtl"></a-asset-item>
        </a-assets>

        <a-assets> <!-- also contains the residue -->
            <a-asset-item id="ester_obj" src="../static/assets/objABfinal.obj"></a-asset-item>
            <a-asset-item id="ester_mtl" src="../static/assets/objABfinal.mtl"></a-asset-item>
        </a-assets>
        ...
        <a-marker preset='letterA' id="glumarker">
