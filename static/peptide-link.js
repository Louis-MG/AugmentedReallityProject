...
function createScaffold(divRoot) {
    ...
    <a-scene id="thescene" embedded = "" artoolkit='patternRatio: 500; sourceType: webcam;'>
      ...
      <!--reagents-->
        ...
        <a-assets>
          <a-asset-item id = "paa-obj" src = "static/assets/test.obj"></a-asset-item>
          <a-asset-item id = "paa-mtl" src = "static/assets/test.mtl"></a-asset-item>
        </a-assets>
      ...
      <a-marker preset = 'kanji' id = "kanjiMarkerSelector">
        <a-obj-model id = "aminoAcid2" src = "#paa-obj" mtl = "#paa-mtl" visible = "false"></a-obj-model>
      </a-marker>
